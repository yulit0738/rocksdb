...
class YulSkipListFactory : public MemTableRepFactory {
public:
	explicit YulSkipListFactory(size_t lookahead = 0) : lookahead_(lookahead) {}

	using MemTableRepFactory::CreateMemTableRep;
  virtual MemTableRep* CreateMemTableRep(const MemTableRep::KeyComparator&,
                                         Allocator*, const SliceTransform*,
                                         Logger* logger) override;
	virtual const char* Name() const override { return "YulSkipListFactory"; }
