...
namespace rocksdb {
	namespace {
		...
		struct TeksFreeSpaceElem {
			...
			//TeksFreeSpaceElem(TeksFreeSpaceElem&& o) = default;
			//
			//TeksFreeSpaceElem& operator=(TeksFreeSpaceElem&& rhs) {
			//	ptr_ = std::move(rhs.ptr_);
			//	size_ = std::move(rhs.size_);
			//	return *this;
			//}

			//TeksFreeSpaceElem(const TeksFreeSpaceElem&) = delete;
			//TeksFreeSpaceElem& operator=(const TeksFreeSpaceElem&) = delete;
		...
		public:
			...
			const TeksFreeSpaceElem& TeksFreeSpaceGet() {
				TeksFreeSpaceElem& x = yul_free_space_.top();
				yul_free_space_.pop();
				return x;
			}
